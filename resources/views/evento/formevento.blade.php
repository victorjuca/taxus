        ...
        <div class="modal-body" style="padding:40px 50px;">
            <form role="form" name = 'formEvento'>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" nombre = "uClave" id="clave" placeholder="Calve del Evento" ng-model = 'evento.clave' required="">
                    <div ng-show="formEvento.$submitted || formEvento.uClave.$touched">
                        <span ng-show="formEvento.uClave.$error.required">Tell us your email.</span>                
                    </div>
                </div>
